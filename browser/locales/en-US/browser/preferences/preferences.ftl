...
home-new-windows-tabs-description2 = Choose what opens in new windows and tabs.
...
home-mode-choice-default-fx =
    .label = Afaq Browser Start Page (Default)
...
## Home Section - Start Page Content

home-prefs-content-header2 = Afaq Browser Start Page Content
home-prefs-content-description2 = The default Afaq Browser start page is local, lightweight, and free of remote promotional content.

home-prefs-afaq-local-description = Search, quick access, downloads, and privacy controls are available without loading remote start-page content.
...
home-prefs-shortcuts-by-option-sponsored =
    .label = Partner shortcuts

home-prefs-recommended-by-header-generic =
    .label = Curated stories
home-prefs-recommended-by-description-generic = Optional stories curated for { -brand-product-name }
...
search-engine-default-desc-2 = This search engine is used from the address bar, search bar, and Afaq Browser start page.
...
search-suggestions-desc = Search suggestions can send typed text to the selected search engine. Keep them off for the quietest privacy profile.
...
search-one-click-desc = Choose the alternative search engines available from search fields and the address bar.
...
sync-mobile-promo = Download Afaq Browser for <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> or <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> to sync with your mobile device.
...
sync-engine-addons =
    .label = Add-ons
    .tooltiptext = Extensions and themes for Afaq Browser desktop
    .accesskey = A
...
history-clear-on-close-option =
    .label = Clear selected data when { -brand-short-name } closes
    .accesskey = r

history-clear-managed-description = Persistent browsing is the default. Use Choose Data to decide what is cleared on exit, or Clear Now for immediate cleanup.

history-clear-summary-keep = Persistent browsing is on. No data is cleared automatically when { -brand-short-name } closes.

history-clear-summary-exit = Exit cleanup will clear { $items } when { -brand-short-name } closes.

history-clear-summary-item-history = browsing and download history

history-clear-summary-item-cookies = cookies and site data

history-clear-summary-item-cache = cached content

history-clear-summary-item-formdata = search and form history

history-clear-summary-item-site-settings = site settings

history-clear-exceptions-summary =
    { $count ->
        [0] No site exceptions are set.
        [one] 1 site exception is set.
       *[other] { $count } site exceptions are set.
    }
...
history-clear-exceptions-description = Preserve keeps site data on exit. Always Clear removes site data for that site even when global cleanup is off.

history-clear-button =
    .label = Clear Now…
    .accesskey = s

afaq-security-header = Afaq Browser Security

afaq-security-description = Manage the browser privacy profile, network behavior, and compatibility tradeoffs from one place.

afaq-security-level-heading = Security Level

afaq-security-level-label =
    .value = Security level:

afaq-security-level-standard =
    .label = Standard

afaq-security-level-hardened =
    .label = Hardened

afaq-security-level-maximum =
    .label = Maximum

afaq-security-level-summary-standard = Standard keeps the privacy baseline active while preserving the broadest site compatibility.

afaq-security-level-summary-hardened = Hardened is the recommended default. It applies stronger fingerprinting resistance, stricter network privacy, and disabled WebRTC for a more predictable privacy posture.

afaq-security-level-summary-maximum = Maximum applies the strongest built-in restrictions. Some media, graphics, real-time communication, and interactive sites may stop working correctly.

afaq-security-level-warning-maximum = Maximum can break login flows, graphics-heavy pages, conferencing, and other advanced sites. Use it only when you accept compatibility tradeoffs.

afaq-security-restore-defaults =
    .label = Restore level defaults

afaq-security-network-heading = Network Privacy

afaq-security-network-description = Tune DNS, prefetching, speculative connections, and remote reputation checks.

afaq-security-doh-label =
    .value = DNS-over-HTTPS:

afaq-security-doh-off = Off

afaq-security-doh-balanced = Mullvad DNS with fallback

afaq-security-doh-strict = Mullvad DNS only

afaq-security-disable-dns-prefetch =
    .label = Disable DNS prefetch

afaq-security-allow-speculative-connections =
    .label = Allow speculative connections from the address bar

afaq-security-remote-safety =
    .label = Enable remote phishing, malware, and download reputation checks

afaq-security-network-summary = Current network posture: { $doh }, DNS prefetch { $dnsPrefetch }, speculative connections { $speculative }, remote safety checks { $remoteSafety }.

afaq-security-advanced-heading = Advanced Controls

afaq-security-advanced-description = Control high-impact web platform surfaces that affect fingerprinting and site behavior.

afaq-security-letterboxing =
    .label = Enable letterboxing

afaq-security-webrtc-mode-label =
    .value = WebRTC policy:

afaq-security-webrtc-mode-protected = Protected

afaq-security-webrtc-mode-disabled = Disabled

afaq-security-disable-webgl =
    .label = Disable WebGL

afaq-security-webrtc-note = Protected keeps calls available while reducing local address exposure. Disabled removes the WebRTC surface, but calling and conferencing sites may stop working.

afaq-security-allow-clipboard-events =
    .label = Allow site clipboard events

afaq-security-allow-pdf-scripting =
    .label = Allow PDF scripting

afaq-security-advanced-summary = Current advanced posture: letterboxing { $letterboxing }, WebRTC { $webRtc }, WebGL { $webGl }, clipboard events { $clipboardEvents }, PDF scripting { $pdfScripting }.

afaq-security-compatibility-heading = Site Compatibility

afaq-security-compatibility-description = Relax common breakage points when needed while keeping the active privacy profile visible.

afaq-security-compatibility-mode-label =
    .value = Compatibility profile:

afaq-security-compatibility-mode-balanced = Balanced

afaq-security-compatibility-mode-troubleshoot = Troubleshoot broken sites

afaq-security-compatibility-summary = Current site posture: profile { $profile }, secure DNS { $doh }, cross-site cookie policy { $cookies }, query stripping { $queryStripping }, HTTPS-only in normal windows { $httpsOnly }.

afaq-security-diagnostics-heading = Diagnostics

afaq-security-diagnostics-description = Diagnostics are read from the browser's active settings. External leak-test sites can disagree, especially when APIs are disabled or partially exposed.

afaq-security-diagnostics-summary = Current diagnostics: WebRTC policy { $webRtcPolicy }, WebRTC API { $webRtcApi }, secure DNS { $doh }, WebGL { $webGl }, context menu protection { $contextMenu }, locale spoofing { $locale }, font visibility { $fonts }, canvas extraction { $canvas }, max hardware concurrency { $hardwareConcurrency }, touch exposure { $touch }.

afaq-security-diagnostics-webrtc-expectation-disabled = External WebRTC leak-test sites may stay on checking or report incomplete results when WebRTC is disabled. Treat that as expected while the API is removed.

afaq-security-diagnostics-webrtc-expectation-protected = External WebRTC leak-test sites may show incomplete or contradictory results when protected mode suppresses host candidates and local addresses.
...
addressbar-suggest = Address bar suggestions

# When Afaq Suggestions is enabled, this replaces `addressbar-header`.
addressbar-header-firefox-suggest = Address Bar — { -firefox-suggest-brand-name }

# When Afaq Suggestions is enabled, this replaces `addressbar-suggest`.
addressbar-suggest-firefox-suggest = Choose the type of suggestions that appear in the address bar.

# When Afaq Suggestions is enabled, a "Learn more" link appears at the end of
...
addressbar-locbar-showtrendingsuggestions-option =
    .label = Show trending search suggestions from the search provider
    .accesskey = t

# Nonsponsored suggestions refers to Afaq Suggestions results like Wikipedia.
...
addressbar-locbar-suggest-sponsored-option =
  .label = Partner suggestions
addressbar-locbar-suggest-sponsored-desc = Partner suggestions are disabled by default in Afaq Browser.

addressbar-quickactions-learn-more = Learn more

addressbar-dismissed-suggestions-label = Dismissed suggestions
addressbar-restore-dismissed-suggestions-description = Restore dismissed suggestions from partners and { -brand-short-name }.
...
preferences-collection-description = Review optional data sharing controls for { -brand-product-name }.
preferences-collection-afaq-baseline = Afaq Browser disables optional telemetry, studies, personalized recommendations, private attribution, Pocket, Relay, and promotional suggestion surfaces by default.
