...
permissions-capabilities-listitem-afaq-preserve =
    .value = Preserve
permissions-capabilities-listitem-afaq-always-clear =
    .value = Always Clear
...
## Exceptions - Afaq Cleanup

permissions-exceptions-afaq-cleanup-window =
    .title = Site Exceptions - Cleanup on Exit
    .style = { permissions-window2.style }
permissions-exceptions-afaq-cleanup-desc = Preserve keeps site data for a website when exit cleanup runs. Always Clear removes site data for that website even when global exit cleanup is disabled.
permissions-afaq-cleanup-preserve =
    .label = Preserve
    .accesskey = P
permissions-afaq-cleanup-always-clear =
    .label = Always Clear
    .accesskey = C
