...
ChromeUtils.defineESModuleGetters(lazy, {
  AfaqAppearanceService: "resource:///modules/AfaqAppearanceService.sys.mjs",
...
BrowserGlue.prototype = {
  ...
  _onWindowsRestored: function BG__onWindowsRestored() {
    ...
    lazy.AfaqAppearanceService.onStartup();
    lazy.AfaqSecurityLevelService.onStartup();
    lazy.AfaqCleanupService.onStartup();
