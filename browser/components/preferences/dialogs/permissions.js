...
const permissionExceptionsL10n = {
  ...
  "afaq-cleanup": {
    window: "permissions-exceptions-afaq-cleanup-window",
    description: "permissions-exceptions-afaq-cleanup-desc",
  },
  install: {
...
var gPermissionManager = {
  ...
  async init(params) {
    ...
    if (params.blockL10nId) {
      document.l10n.setAttributes(
        document.getElementById("btnBlock"),
        params.blockL10nId
      );
    }
    if (params.allowL10nId) {
      document.l10n.setAttributes(
  ...
  _getCapabilityL10nId(capability) {
    ...
    if (this._type == "afaq-cleanup") {
      return this._getAfaqCleanupCapabilityL10nId(capability);
    }
  ...
  _getAfaqCleanupCapabilityL10nId(capability) {
    switch (capability) {
      case Ci.nsIPermissionManager.ALLOW_ACTION:
        return "permissions-capabilities-listitem-afaq-preserve";
      case Ci.nsIPermissionManager.DENY_ACTION:
        return "permissions-capabilities-listitem-afaq-always-clear";
      default:
        throw new Error(`Unknown Afaq cleanup capability: ${capability}`);
    }
  },
