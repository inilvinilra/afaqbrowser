...
/*---------------------------- macros ----------------------------*/
#if defined(__GLIBC_USE_ISOC23) && __GLIBC_USE_ISOC23 && !defined(__cplusplus)
#define EMULATED_THREADS_HAVE_GLIBC_ISOC23
#endif

#ifndef EMULATED_THREADS_HAVE_GLIBC_ISOC23
